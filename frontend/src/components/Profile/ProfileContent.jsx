          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              <div className="w-full 800px:flex block pb-3">
                ...
                <div className=" w-[100%] 800px:w-[50%]">
                  <label className="block pb-2">Адрес электронной почты</label>
                  <input
                    type="text"
                    className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
                    required
              ...
              <div className="w-full 800px:flex block pb-3">
                ...
                <div className=" w-[100%] 800px:w-[50%]">
                  <label className="block pb-2">Введите свой пароль</label>
                  <input
                    type="password"
                    className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
                    required
              ...
              <input
                className={`w-[150px] 800px:w-[180px] mt-2 flex items-center justify-center bg-[#359cf1] h-[50px] my-3 rounded cursor-pointer text-white font-bold`}
                required
                value="Обновить"
                type="submit"
              />
      ...
      <div className="w-full">
        ...
        >
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            <label className="block pb-2">Введите новый пароль</label>
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
              required
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            <label className="block pb-2">Введите подтверждение пароля</label>
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
              required
            ...
            />
            <input
              className={`w-[150px] 800px:w-[180px] mt-5  flex items-center justify-center bg-[#359cf1] h-[50px] my-3 rounded cursor-pointer text-white font-bold`}
              required
              value="Обновить"
              type="submit"
            />
...
const Address = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (addressType === "" || country === "" || city === "") {
      ...
      setCity("");
      setAddress("");
      setZipCode(null); // тип возвращаемого значения - int, поэтому по умолчанию null
      setAddressType("");
    }
  };
              ...
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2">Выберите ваш город</label>
                    <select
                      name=""
                      id=""
                      value={city}
